    ...
    <main className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-md mx-auto">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-red-900">Administración</h1>
        ...
        <div className="bg-white rounded-2xl p-4 shadow mb-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <button
              ...
              className="w-full bg-red-700 text-white px-4 py-2 rounded-xl text-sm font-semibold">
              Agregar
            </button>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-4 shadow mb-4">
          ...
          <button
            ...
            className="w-full bg-red-700 text-white py-2 rounded-xl text-sm font-semibold">
            Crear Grupo
          </button>
        </div>
